...
# for - цикл работает до тех пор, пока элементы в итерируемом обьекте не заканчивается. 
...
#         else:
#                 none_iter_objs.append(obj) 
# print(f'Итерируемые объекты: {iter_objs}')    
# print(f'Неитерируемые объекты: {none_iter_objs}')     


# range() - фунция для генерации последовательности чисел 
...
# Запрашивать сообщение до тех пор, пока сообщение не будет = stop

# msg = input('Введите сообщение или STOP ')
# while msg != 'STOP':
#         print(msg)                                    - первый вариант остановки цикла 
#         msg = input('Введите сообщение или STOP ')
...
#         msg = input('Введите сообщение или stop ')
#         if msg == 'stop':
#                 print('цикл остановлен')              - второй вариант остановки цикла
#                 break
#         print(msg)

# Печатать сообщение до тез пор, пока оно не будет равно 'bye'
...
# else - срабатывает при успешном окончании цикла